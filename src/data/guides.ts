...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    description:
      "USGS zones 1–9 are long-term relative hazard, not a parcel survey and not a forecast. Lava is not hurricane or flood. How I walk the map and the insurance file.",
