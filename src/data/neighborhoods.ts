...
export const NEIGHBORHOODS: Neighborhood[] = [
  {
    ...
    living: [
      ...
      "Tradewinds and ocean exposure shape the day more than a floor plan does. If you need a city rhythm, this is the wrong end of the island. If you want a town you can walk and a landscape that still feels like Kohala, we start here — then we verify water and the map.",
    ],
    water:
  ...
  },
  {
    ...
    living: [
      ...
      "If you are relocating from a city, this is often the first place that feels operable. That does not make every condo the right home. Ocean proximity, parking, and whether you can actually live with visitors in the street are the conversation, not the sunset.",
    ],
    water:
  ...
  },
  {
    ...
    water:
      "Mauka farms and rural lots are often on catchment. A county line in the road does not mean this house has a meter. Dual catchment plus a meter is a backflow issue for DWS, not something you add later on your own.",
    lava:
  ...
  },
  {
    ...
    living: [
      ...
      "Towns are small. The landscape is the point. I will not call that a resort. I will ask whether you can live with the drive, the weather, and the fact that “the coast” here means cliffs and ocean, not a swim at lunch.",
    ],
    water:
  ...
  },
  {
    slug: "puna",
    name: "Puna",
    lede: "A large east-side district: rainforest, lava land, and homework that goes beyond the kitchen.",
    living: [
