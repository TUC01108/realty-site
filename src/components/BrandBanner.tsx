  ...
  return (
    <section className="relative text-paper">
      <div className="absolute inset-0">
        <Image src="/images/coldwell-banner.jpeg" alt="Luxury Hawai'i property at dusk" fill className="object-cover" />
        <div className="absolute inset-0 bg-ink/50" />
      </div>
      <div className="relative mx-auto max-w-6xl px-6 lg:px-8 py-20 text-center">
        <p className="font-display text-2xl lg:text-3xl">Coldwell Banker Global Luxury&reg;</p>
