...
export const metadata: Metadata = {
  ...
  description:
    "Discover life across Hawai'i Island's nine unique districts — from the resort communities of South Kohala to the lush rainforests of Hāmākua. Yordana Bolanos Salas, Coldwell Banker Island Properties.",
};
      ...
      <section className="bg-sand py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <p className="mt-6 text-ink/70 max-w-xl leading-relaxed">
            Hawai&apos;i Island is unlike anywhere else in the world — nine
            distinct districts, each with its own character, climate, and
            community. Explore them below to find the one that feels like home.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {NEIGHBORHOODS.map((area) => (
            ...
            >
              ...
              <div className="mt-4">
                <h2 className="font-display text-xl text-ink group-hover:text-coral transition-colors">
                  {area.name}
                </h2>
                ...
                <div className="mt-3 flex gap-4 text-xs text-ink/50">
                  <span>{area.medianPrice}</span>
                  <span>·</span>
                  <span>{area.density} density</span>
                </div>
              </div>
            </Link>
          ))}
