    ...
    <>
      ...
      >
        ...
        <p>
          ...
          the zoning-district, NUC, and State Ag limits here:{" "}
          <a href="/guides/hawaii-county-short-term-vacation-rentals" className="text-coral border-b border-coral">
            short-term vacation rentals in Hawaiʻi County
          </a>
          . If overnight visitor use is why you are buying, we verify with Planning on that TMK before
          you write — East Hawaiʻi 808-961-8288, West Hawaiʻi 808-323-4770.
        </p>
        <p>
